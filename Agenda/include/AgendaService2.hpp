...
public:
	...
	//get user'email and phone from name

	User getUser(const std::string &userName);
	//Õÿ’π
	//–ﬁ∏ƒ√‹¬Î
	bool updateUserName(const std::string &userName, const std::string &password, const std::string &newnam);
	bool updateUserpassword(const std::string &userName, const std::string &password, const std::string & newpassword);
	//change phone
	bool updateUserphone(const std::string &userName, const std::string &password, const std::string &newphone);
	//change email
	bool upadateUseremail(const std::string &userName, const std::string &password, const std::string &newphone);
